...
If your output contains a single em dash (U+2014) or en dash (U+2013) anywhere visible to the user, the output fails the Pre-Flight Check and must be rewritten.
