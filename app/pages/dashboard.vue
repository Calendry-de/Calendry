<template>
    <CommonPage title="Signed in">
        <!--
            ...
            metrics sense, and the name is about the ROUTE rather than a promise
            of charts.

            It moved here from `/` when the public landing page took the root.
            Nothing about the page changed in the move — the route did, and
            `HOME_ROUTE` in `~/utils/routes` is the single place that says so.
            ...
            exists — and go stale again — it lists the destinations the nav
