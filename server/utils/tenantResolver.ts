 ...
 *     designed to be pasted into third-party apps and not guarded like a
 ...
 * refuses without one, and the token's set is further intersected with its
 ...
 * configured once by typing a URL and never touched again, so there is nowhere to
 ...
 * left to refetch it unattended, so there is nowhere to put a header.
