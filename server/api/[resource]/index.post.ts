                            ...
                            },
                            {
                                ...
                                properties: {
                                    ...
                                    createdFromTemplateId: {
                                        type: 'string',
                                        nullable: true,
                                        description: 'PROVENANCE ONLY, set once by the "start from a template" picker (issue #8). Create-only and absent from PATCH; never consulted to resolve a field value.',
                                    },
                                },
                            },
                            {
