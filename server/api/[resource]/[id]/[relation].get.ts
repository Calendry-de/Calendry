...
defineRouteMeta({
    openAPI: {
        ...
        description: 'The current membership set of one relation, e.g. the Groups an Offering is for. Requires the PARENT resource read permission. Valid pairs: time-grids/breaks, groups/terms, groups/sources, groups/availability, offerings/groups, offerings/lecturers, offerings/equipment, rooms/footprint, rooms/equipment, persons/roles, persons/access-roles, persons/groups, constraints/scopes.',
        parameters: [
